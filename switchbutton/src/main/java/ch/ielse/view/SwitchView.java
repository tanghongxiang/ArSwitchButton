...
public class SwitchView extends View {
    ...
    protected float ratioAspect = 0.68f; // (0,1]//0.68f
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        colorBG = a.getColor(R.styleable.SwitchView_colorBG, 0xFFFFFFFF);
    ...
    public void setCustomArColor(int newColorPrimaryDark, int colorBG) {
        colorPrimaryDark = newColorPrimaryDark;
        colorOff = colorBG;//关闭时外围椭圆边框颜色
        colorOffDark = colorBG;//关闭时小圆圈边框颜色
        this.colorBG = colorBG;
        invalidate();
    }

    public void setCustomEnColor(int newColorPrimaryDark) {
        colorPrimaryDark = newColorPrimaryDark;
        colorOff = 0xFFE3E3E3;//关闭时外围椭圆边框颜色
        colorOffDark = 0xFFE3E3E3;//关闭时小圆圈边框颜色
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isAr) {
            if (!isOn) {
                ...
                //TODO 开启状态下描边还是填充
                paint.setColor(isOn ? colorPrimary : colorOff);//colorPrimary
        ...
        /*paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(bStrokeWidth* 0.5f);//
        paint.setColor(isOn ? colorPrimaryDark : colorBG);
        canvas.drawPath(sPath, paint);
        canvas.save();*/
        //-----
...
//        paint.setColor(0xFFFFFFFF);
        paint.setColor(isAr?colorBG:0xFFFFFFFF);//关闭状态背景色
        canvas.drawPath(sPath, paint);
        canvas.restore();
        ...
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(0xffffffff);//画小圆圈背景色
        canvas.drawPath(bPath, paint);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(bStrokeWidth * 0.5f);//
    ...
    public void setLanguage(boolean isAr){
        this.isAr=isAr;
        invalidate();
    }
}
